    ...
    protected void fillCollectionSet(String urlString, Request request, CollectionAgent agent, CollectionSetBuilder builder, XmlSource source) throws Exception {
        ...
        for (XmlGroup group : source.getXmlGroups()) {
            ...
            for (XmlObject object : group.getXmlObjects()) {
                ...
                if (type.isNumeric()) {
                    builder.withNumericAttribute(collectionResource, group.getName(), object.getName(), NumericAttributeUtils.parseNumericValue(el.html()), type);
                } else {
                    builder.withStringAttribute(collectionResource, group.getName(), object.getName(), el.html());
                }
            }
